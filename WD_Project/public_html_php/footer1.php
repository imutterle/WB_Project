<html>
    ...
    <body>
        <footer class="footer footer-inverse navbar-fixed-bottom">
            ...
            <div class="footer-bottom">
                <div class="VociFooterBasse">
                    <a href="#" class="FooterBasso">termini d'uso&nbsp;|</a>
                    <a href="#" class="FooterBasso">privacy&nbsp;|</a>
                    <a href="#" class="FooterBasso">SiteIndex</a>
                </div>
            </div> 
        </footer>

        <!-- Costruzione Form Contact Us -->
        <!--manca colore grigio, ridimensionare lungo tutta la linea e pulsante X-->
        ...
        <!-- manca colore grigio sfondo e pulsante X -->
                    ...
                    <div class="modal-content">
                            <div class="modal-body">
                                <form class="form-horizontal" action=" " method="post"  id="contact_form">
                                    ...
                                    <div class="form-group">                                            
                                        <ul><input class="form-control" name="e_mail" placeholder="Enter e-mail" type="text"></ul>
                                        <button type="button" class="btn-news">Submit</button>
                                    </div>   
                                </form>
                            </div>
                    </div>
