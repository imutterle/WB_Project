<html lang="it">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="path">
                <a href="../homepage.php">Home</a> / <a href="../Projects.php">Projects</a> / <a href="../projects/SpatialTourism.php">Spatial Tourism</a> / <a href="dettaglioCircumlunarMission.php">Circumlunar Mission</a>
            </div>
            ...
            <div class="col-md-7">
                ...
                <p> See also our new <a href="../projects/Rockets.php">Rockets</a> which are involved with this mission!</p>
            </div>
            <div class="col-md-12">
            ...
            <div class="exp-details col-md-12">
                <h4>Prices: &#36 total </h4>
            </div>
            <div class="exp-details col-md-12">
                <h4>Contact Directly: <a href="#">example@example.com</a></h4>
            </div>
            <div class="exp-details col-md-12">
                <h4><a href="../gallery/gallery.php">Gallery</a></h4>
            </div>
            <div class="container">
                <div class="col-md-3">
